...
@FragmentScoped
class DestinationAdapter @Inject constructor() : ListAdapter<DestinationModel, DestinationAdapter.DestinationViewHolder>(DestinationDiff()) {
    ...
    class DestinationViewHolder(private val clickRelay: PublishSubject<DestinationModel>,val binding:DestinationRvBinding) : RecyclerView.ViewHolder(binding.root) {
...
class DestinationDiff : DiffUtil.ItemCallback<DestinationModel>() {
